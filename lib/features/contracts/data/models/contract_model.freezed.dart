...
mixin _$ContractItemModel {
 ...
 String get id; String get vehicleName; String get clientName; String get clientId; String? get status; String? get vehicleImage; String? get contractType; String? get contractDirection; String? get totalServiceFee; String? get serviceContractPdf; String? get productName; String? get productYear; String? get collectorFirstName; String? get collectorLastName; String? get totalPrice; String? get initialPayment; String? get installmentAmount; int? get installmentPeriodMonths; String? get interestRate; String? get totalInterest; String? get monthlyPayment; String? get productPrice; String? get userFirstName; String? get userLastName; String? get approvedByAdminFirstName; String? get approvedByAdminLastName; List<String>? get productImageUrls; bool? get userAccepted; String? get paymentType;
...
@useResult
$Res call({
 String id, String vehicleName, String clientName, String clientId, String? status, String? vehicleImage, String? contractType, String? contractDirection, String? totalServiceFee, String? serviceContractPdf, String? productName, String? productYear, String? collectorFirstName, String? collectorLastName, String? totalPrice, String? initialPayment, String? installmentAmount, int? installmentPeriodMonths, String? interestRate, String? totalInterest, String? monthlyPayment, String? productPrice, String? userFirstName, String? userLastName, String? approvedByAdminFirstName, String? approvedByAdminLastName, List<String>? productImageUrls, bool? userAccepted, String? paymentType
});
...
/// Create a copy of ContractItemModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? vehicleName = null,Object? clientName = null,Object? clientId = null,Object? status = freezed,Object? vehicleImage = freezed,Object? contractType = freezed,Object? contractDirection = freezed,Object? totalServiceFee = freezed,Object? serviceContractPdf = freezed,Object? productName = freezed,Object? productYear = freezed,Object? collectorFirstName = freezed,Object? collectorLastName = freezed,Object? totalPrice = freezed,Object? initialPayment = freezed,Object? installmentAmount = freezed,Object? installmentPeriodMonths = freezed,Object? interestRate = freezed,Object? totalInterest = freezed,Object? monthlyPayment = freezed,Object? productPrice = freezed,Object? userFirstName = freezed,Object? userLastName = freezed,Object? approvedByAdminFirstName = freezed,Object? approvedByAdminLastName = freezed,Object? productImageUrls = freezed,Object? userAccepted = freezed,Object? paymentType = freezed,}) {
  return _then(_self.copyWith(
...
as String?,contractDirection: freezed == contractDirection ? _self.contractDirection : contractDirection // ignore: cast_nullable_to_non_nullable
...
as String?,productYear: freezed == productYear ? _self.productYear : productYear // ignore: cast_nullable_to_non_nullable
...
as List<String>?,userAccepted: freezed == userAccepted ? _self.userAccepted : userAccepted // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String vehicleName,  String clientName,  String clientId,  String? status,  String? vehicleImage,  String? contractType,  String? contractDirection,  String? totalServiceFee,  String? serviceContractPdf,  String? productName,  String? productYear,  String? collectorFirstName,  String? collectorLastName,  String? totalPrice,  String? initialPayment,  String? installmentAmount,  int? installmentPeriodMonths,  String? interestRate,  String? totalInterest,  String? monthlyPayment,  String? productPrice,  String? userFirstName,  String? userLastName,  String? approvedByAdminFirstName,  String? approvedByAdminLastName,  List<String>? productImageUrls,  bool? userAccepted,  String? paymentType)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ContractItemModel() when $default != null:
return $default(_that.id,_that.vehicleName,_that.clientName,_that.clientId,_that.status,_that.vehicleImage,_that.contractType,_that.contractDirection,_that.totalServiceFee,_that.serviceContractPdf,_that.productName,_that.productYear,_that.collectorFirstName,_that.collectorLastName,_that.totalPrice,_that.initialPayment,_that.installmentAmount,_that.installmentPeriodMonths,_that.interestRate,_that.totalInterest,_that.monthlyPayment,_that.productPrice,_that.userFirstName,_that.userLastName,_that.approvedByAdminFirstName,_that.approvedByAdminLastName,_that.productImageUrls,_that.userAccepted,_that.paymentType);case _:
  return orElse();
...
class _ContractItemModel extends ContractItemModel {
  const _ContractItemModel({required this.id, required this.vehicleName, required this.clientName, required this.clientId, this.status, this.vehicleImage, this.contractType, this.contractDirection, this.totalServiceFee, this.serviceContractPdf, this.productName, this.productYear, this.collectorFirstName, this.collectorLastName, this.totalPrice, this.initialPayment, this.installmentAmount, this.installmentPeriodMonths, this.interestRate, this.totalInterest, this.monthlyPayment, this.productPrice, this.userFirstName, this.userLastName, this.approvedByAdminFirstName, this.approvedByAdminLastName, final  List<String>? productImageUrls, this.userAccepted, this.paymentType}): _productImageUrls = productImageUrls,super._();
...
@override final  bool? userAccepted;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ContractItemModel&&(identical(other.id, id) || other.id == id)&&(identical(other.vehicleName, vehicleName) || other.vehicleName == vehicleName)&&(identical(other.clientName, clientName) || other.clientName == clientName)&&(identical(other.clientId, clientId) || other.clientId == clientId)&&(identical(other.status, status) || other.status == status)&&(identical(other.vehicleImage, vehicleImage) || other.vehicleImage == vehicleImage)&&(identical(other.contractType, contractType) || other.contractType == contractType)&&(identical(other.contractDirection, contractDirection) || other.contractDirection == contractDirection)&&(identical(other.totalServiceFee, totalServiceFee) || other.totalServiceFee == totalServiceFee)&&(identical(other.serviceContractPdf, serviceContractPdf) || other.serviceContractPdf == serviceContractPdf)&&(identical(other.productName, productName) || other.productName == productName)&&(identical(other.productYear, productYear) || other.productYear == productYear)&&(identical(other.collectorFirstName, collectorFirstName) || other.collectorFirstName == collectorFirstName)&&(identical(other.collectorLastName, collectorLastName) || other.collectorLastName == collectorLastName)&&(identical(other.totalPrice, totalPrice) || other.totalPrice == totalPrice)&&(identical(other.initialPayment, initialPayment) || other.initialPayment == initialPayment)&&(identical(other.installmentAmount, installmentAmount) || other.installmentAmount == installmentAmount)&&(identical(other.installmentPeriodMonths, installmentPeriodMonths) || other.installmentPeriodMonths == installmentPeriodMonths)&&(identical(other.interestRate, interestRate) || other.interestRate == interestRate)&&(identical(other.totalInterest, totalInterest) || other.totalInterest == totalInterest)&&(identical(other.monthlyPayment, monthlyPayment) || other.monthlyPayment == monthlyPayment)&&(identical(other.productPrice, productPrice) || other.productPrice == productPrice)&&(identical(other.userFirstName, userFirstName) || other.userFirstName == userFirstName)&&(identical(other.userLastName, userLastName) || other.userLastName == userLastName)&&(identical(other.approvedByAdminFirstName, approvedByAdminFirstName) || other.approvedByAdminFirstName == approvedByAdminFirstName)&&(identical(other.approvedByAdminLastName, approvedByAdminLastName) || other.approvedByAdminLastName == approvedByAdminLastName)&&const DeepCollectionEquality().equals(other._productImageUrls, _productImageUrls)&&(identical(other.userAccepted, userAccepted) || other.userAccepted == userAccepted)&&(identical(other.paymentType, paymentType) || other.paymentType == paymentType));
}


@override
int get hashCode => Object.hashAll([runtimeType,id,vehicleName,clientName,clientId,status,vehicleImage,contractType,contractDirection,totalServiceFee,serviceContractPdf,productName,productYear,collectorFirstName,collectorLastName,totalPrice,initialPayment,installmentAmount,installmentPeriodMonths,interestRate,totalInterest,monthlyPayment,productPrice,userFirstName,userLastName,approvedByAdminFirstName,approvedByAdminLastName,const DeepCollectionEquality().hash(_productImageUrls),userAccepted,paymentType]);
...
/// Create a copy of ContractItemModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? vehicleName = null,Object? clientName = null,Object? clientId = null,Object? status = freezed,Object? vehicleImage = freezed,Object? contractType = freezed,Object? contractDirection = freezed,Object? totalServiceFee = freezed,Object? serviceContractPdf = freezed,Object? productName = freezed,Object? productYear = freezed,Object? collectorFirstName = freezed,Object? collectorLastName = freezed,Object? totalPrice = freezed,Object? initialPayment = freezed,Object? installmentAmount = freezed,Object? installmentPeriodMonths = freezed,Object? interestRate = freezed,Object? totalInterest = freezed,Object? monthlyPayment = freezed,Object? productPrice = freezed,Object? userFirstName = freezed,Object? userLastName = freezed,Object? approvedByAdminFirstName = freezed,Object? approvedByAdminLastName = freezed,Object? productImageUrls = freezed,Object? userAccepted = freezed,Object? paymentType = freezed,}) {
