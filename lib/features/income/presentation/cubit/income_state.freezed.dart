...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is IncomeState);
}
...
class _Initial implements IncomeState {
  const _Initial();
...
class _Loading implements IncomeState {
  const _Loading();
...
class _Loaded implements IncomeState {
  const _Loaded(this.incomeSources);
  

 final  IncomeSourcesEntity incomeSources;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Loaded&&(identical(other.incomeSources, incomeSources) || other.incomeSources == incomeSources));
}


@override
int get hashCode => Object.hash(runtimeType,incomeSources);

@override
String toString() {
  return 'IncomeState.loaded(incomeSources: $incomeSources)';
}
...
/// @nodoc
abstract mixin class _$LoadedCopyWith<$Res> implements $IncomeStateCopyWith<$Res> {
  factory _$LoadedCopyWith(_Loaded value, $Res Function(_Loaded) _then) = __$LoadedCopyWithImpl;
@useResult
$Res call({
 IncomeSourcesEntity incomeSources
});
...
/// Create a copy of IncomeState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? incomeSources = null,}) {
  return _then(_Loaded(
null == incomeSources ? _self.incomeSources : incomeSources // ignore: cast_nullable_to_non_nullable
as IncomeSourcesEntity,
  ));
}
...
class _Error implements IncomeState {
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $IncomeStateCopyWith<$Res> {
