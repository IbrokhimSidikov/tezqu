...
@useResult
$Res call({
@JsonKey(name: 'total_payments_this_month') double totalPaymentsThisMonth,@JsonKey(name: 'total_income_this_month') double totalIncomeThisMonth,@JsonKey(name: 'total_expenses_this_month') double totalExpensesThisMonth,@JsonKey(name: 'total_products_qty') int totalProductsQty,@JsonKey(name: 'net_profit_this_month') double netProfitThisMonth,@JsonKey(name: 'active_contracts_count') int activeContractsCount,@JsonKey(name: 'pending_payments_count') int pendingPaymentsCount,@JsonKey(name: 'total_contract_amount') double totalContractAmount,@JsonKey(name: 'total_paid') double totalPaid,@JsonKey(name: 'total_remaining') double totalRemaining,@JsonKey(name: 'next_payment_amount') double nextPaymentAmount,@JsonKey(name: 'next_payment_date') String nextPaymentDate,@JsonKey(name: 'active_contracts') int activeContracts
});
...
/// Create a copy of DashboardDataModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? totalPaymentsThisMonth = null,Object? totalIncomeThisMonth = null,Object? totalExpensesThisMonth = null,Object? totalProductsQty = null,Object? netProfitThisMonth = null,Object? activeContractsCount = null,Object? pendingPaymentsCount = null,Object? totalContractAmount = null,Object? totalPaid = null,Object? totalRemaining = null,Object? nextPaymentAmount = null,Object? nextPaymentDate = null,Object? activeContracts = null,}) {
  return _then(_self.copyWith(
totalPaymentsThisMonth: null == totalPaymentsThisMonth ? _self.totalPaymentsThisMonth : totalPaymentsThisMonth // ignore: cast_nullable_to_non_nullable
as double,totalIncomeThisMonth: null == totalIncomeThisMonth ? _self.totalIncomeThisMonth : totalIncomeThisMonth // ignore: cast_nullable_to_non_nullable
...
as double,totalProductsQty: null == totalProductsQty ? _self.totalProductsQty : totalProductsQty // ignore: cast_nullable_to_non_nullable
as int,netProfitThisMonth: null == netProfitThisMonth ? _self.netProfitThisMonth : netProfitThisMonth // ignore: cast_nullable_to_non_nullable
as double,activeContractsCount: null == activeContractsCount ? _self.activeContractsCount : activeContractsCount // ignore: cast_nullable_to_non_nullable
as int,pendingPaymentsCount: null == pendingPaymentsCount ? _self.pendingPaymentsCount : pendingPaymentsCount // ignore: cast_nullable_to_non_nullable
as int,totalContractAmount: null == totalContractAmount ? _self.totalContractAmount : totalContractAmount // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'total_payments_this_month')  double totalPaymentsThisMonth, @JsonKey(name: 'total_income_this_month')  double totalIncomeThisMonth, @JsonKey(name: 'total_expenses_this_month')  double totalExpensesThisMonth, @JsonKey(name: 'total_products_qty')  int totalProductsQty, @JsonKey(name: 'net_profit_this_month')  double netProfitThisMonth, @JsonKey(name: 'active_contracts_count')  int activeContractsCount, @JsonKey(name: 'pending_payments_count')  int pendingPaymentsCount, @JsonKey(name: 'total_contract_amount')  double totalContractAmount, @JsonKey(name: 'total_paid')  double totalPaid, @JsonKey(name: 'total_remaining')  double totalRemaining, @JsonKey(name: 'next_payment_amount')  double nextPaymentAmount, @JsonKey(name: 'next_payment_date')  String nextPaymentDate, @JsonKey(name: 'active_contracts')  int activeContracts)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DashboardDataModel() when $default != null:
return $default(_that.totalPaymentsThisMonth,_that.totalIncomeThisMonth,_that.totalExpensesThisMonth,_that.totalProductsQty,_that.netProfitThisMonth,_that.activeContractsCount,_that.pendingPaymentsCount,_that.totalContractAmount,_that.totalPaid,_that.totalRemaining,_that.nextPaymentAmount,_that.nextPaymentDate,_that.activeContracts);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'total_payments_this_month')  double totalPaymentsThisMonth, @JsonKey(name: 'total_income_this_month')  double totalIncomeThisMonth, @JsonKey(name: 'total_expenses_this_month')  double totalExpensesThisMonth, @JsonKey(name: 'total_products_qty')  int totalProductsQty, @JsonKey(name: 'net_profit_this_month')  double netProfitThisMonth, @JsonKey(name: 'active_contracts_count')  int activeContractsCount, @JsonKey(name: 'pending_payments_count')  int pendingPaymentsCount, @JsonKey(name: 'total_contract_amount')  double totalContractAmount, @JsonKey(name: 'total_paid')  double totalPaid, @JsonKey(name: 'total_remaining')  double totalRemaining, @JsonKey(name: 'next_payment_amount')  double nextPaymentAmount, @JsonKey(name: 'next_payment_date')  String nextPaymentDate, @JsonKey(name: 'active_contracts')  int activeContracts)  $default,) {final _that = this;
switch (_that) {
case _DashboardDataModel():
return $default(_that.totalPaymentsThisMonth,_that.totalIncomeThisMonth,_that.totalExpensesThisMonth,_that.totalProductsQty,_that.netProfitThisMonth,_that.activeContractsCount,_that.pendingPaymentsCount,_that.totalContractAmount,_that.totalPaid,_that.totalRemaining,_that.nextPaymentAmount,_that.nextPaymentDate,_that.activeContracts);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'total_payments_this_month')  double totalPaymentsThisMonth, @JsonKey(name: 'total_income_this_month')  double totalIncomeThisMonth, @JsonKey(name: 'total_expenses_this_month')  double totalExpensesThisMonth, @JsonKey(name: 'total_products_qty')  int totalProductsQty, @JsonKey(name: 'net_profit_this_month')  double netProfitThisMonth, @JsonKey(name: 'active_contracts_count')  int activeContractsCount, @JsonKey(name: 'pending_payments_count')  int pendingPaymentsCount, @JsonKey(name: 'total_contract_amount')  double totalContractAmount, @JsonKey(name: 'total_paid')  double totalPaid, @JsonKey(name: 'total_remaining')  double totalRemaining, @JsonKey(name: 'next_payment_amount')  double nextPaymentAmount, @JsonKey(name: 'next_payment_date')  String nextPaymentDate, @JsonKey(name: 'active_contracts')  int activeContracts)?  $default,) {final _that = this;
switch (_that) {
case _DashboardDataModel() when $default != null:
return $default(_that.totalPaymentsThisMonth,_that.totalIncomeThisMonth,_that.totalExpensesThisMonth,_that.totalProductsQty,_that.netProfitThisMonth,_that.activeContractsCount,_that.pendingPaymentsCount,_that.totalContractAmount,_that.totalPaid,_that.totalRemaining,_that.nextPaymentAmount,_that.nextPaymentDate,_that.activeContracts);case _:
  return null;
...
class _DashboardDataModel extends DashboardDataModel {
  const _DashboardDataModel({@JsonKey(name: 'total_payments_this_month') this.totalPaymentsThisMonth = 0, @JsonKey(name: 'total_income_this_month') this.totalIncomeThisMonth = 0, @JsonKey(name: 'total_expenses_this_month') this.totalExpensesThisMonth = 0, @JsonKey(name: 'total_products_qty') this.totalProductsQty = 0, @JsonKey(name: 'net_profit_this_month') this.netProfitThisMonth = 0, @JsonKey(name: 'active_contracts_count') this.activeContractsCount = 0, @JsonKey(name: 'pending_payments_count') this.pendingPaymentsCount = 0, @JsonKey(name: 'total_contract_amount') this.totalContractAmount = 0, @JsonKey(name: 'total_paid') this.totalPaid = 0, @JsonKey(name: 'total_remaining') this.totalRemaining = 0, @JsonKey(name: 'next_payment_amount') this.nextPaymentAmount = 0, @JsonKey(name: 'next_payment_date') this.nextPaymentDate = '', @JsonKey(name: 'active_contracts') this.activeContracts = 0}): super._();
...
/// Create a copy of DashboardDataModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? totalPaymentsThisMonth = null,Object? totalIncomeThisMonth = null,Object? totalExpensesThisMonth = null,Object? totalProductsQty = null,Object? netProfitThisMonth = null,Object? activeContractsCount = null,Object? pendingPaymentsCount = null,Object? totalContractAmount = null,Object? totalPaid = null,Object? totalRemaining = null,Object? nextPaymentAmount = null,Object? nextPaymentDate = null,Object? activeContracts = null,}) {
